 ...
 */
final class Version20200211130252 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE content_headword (content_id INT NOT NULL, headword_id INT NOT NULL, INDEX IDX_A0BA4AB584A0A3ED (content_id), INDEX IDX_A0BA4AB5D7DCAEF0 (headword_id), PRIMARY KEY(content_id, headword_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
