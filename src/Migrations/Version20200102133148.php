 ...
 */
final class Version20200102133148 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE content ADD author_id INT DEFAULT NULL, CHANGE headword_id headword_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE content DROP author_id, CHANGE headword_id headword_id INT DEFAULT NULL');
    }
}
